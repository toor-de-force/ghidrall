...
class Comparator:
    ...
    def __init__(self,source_1_path,source_2_path):
        ...
        self.setup()
        self.optimization_pass(source_1_path)
        self.g1_call = self.get_call_graph("comparator/optimized_module/module.ll")
        self.g1_mem = self.get_mem_graph("comparator/optimized_module/module.ll",source_1_path)
        self.setup()
        self.optimization_pass(source_2_path)
        self.g2_call = self.get_call_graph("comparator/optimized_module/module.ll")
        self.g2_mem = self.get_mem_graph("comparator/optimized_module/module.ll",source_2_path)
        self.calculate_similarity_percentage()
    pass
    def optimization_pass(self,path):
        f = open(path,"r")
        llvm_ir = f.read()
        f.close()
        f = open("comparator/optimized_module/module.ll","wt")
        try:
    ...
    def get_call_graph(self,path):
        ...
        return callgraph_nx
    def get_mem_graph(self,path,non_optimized_path):
        ...
        if len(mem_graphs) == 0:
            # raise Exception("empty memory graph")
            call = mem_graph.format(path=non_optimized_path)
            os.system(call)
            mem_graphs = []
            with os.scandir("comparator/mem_results") as m:
                for mem_dot in m:
    ...
    def calculate_similarity_percentage(self):
        self.use_call_graphs_string_compression()
        self.use_mem_graphs_string_compression()
        self.use_call_graphs_iterator()
        self.use_mem_graphs_iterator()
        pass
    def use_call_graphs_string_compression(self):
    ...
    def setup(self):
        ...
        # os.mkdir("comparator/optimized_module", mode=0o777)
        pass
    def cleanup(self):
        try:
