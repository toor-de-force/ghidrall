...
"3":
  %".50" = call i32 @"sym.cgc_sendline"(i32 1, i32 135603264, i32 30)
...
"9":
  %".87" = call i32 @"sym.cgc_sendline"(i32 1, i32 135603264, i32 30)
...
e:
  ...
  br label %"14"
f:
  %".132" = call i32 @"sym.cgc_sendline"(i32 1, i32 135605812, i32 9)
