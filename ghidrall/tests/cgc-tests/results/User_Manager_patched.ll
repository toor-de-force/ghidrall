...
"0":
  ...
  %".24" = call i32 @"sym.cgc_printf"(i32 134543938, i32 %".23")
  br label %"1"
"1":
  %".26" = load i32, i32* %"in_stack_ffffffb8"
  %".27" = call i32 @"sym.cgc_printf"(i32 134543961, i32 %".26")
  %".28" = load i32, i32* %"in_stack_ffffffb8"
  %".29" = call i32 @"sym.cgc_printf"(i32 134543977, i32 %".28")
  %".30" = load i32, i32* %"in_stack_ffffffb8"
  %".31" = call i32 @"sym.cgc_printf"(i32 134543992, i32 %".30")
  %".32" = load i32, i32* %"in_stack_ffffffb8"
  %".33" = call i32 @"sym.cgc_printf"(i32 134544008, i32 %".32")
...
"4":
  ...
  %".73" = mul i32 %".72", 4
  %".74" = add i32 %".73", 134543872
  call void @"unique0x00000f30"()
  ret void
"5":
  %".77" = load i32, i32* %"in_stack_ffffffb8"
  %".78" = call i32 @"sym.cgc_printf"(i32 134544017, i32 %".77")
  br label %"1"
}
...
"0":
  ...
  %".17" = ptrtoint i8* %".16" to i32
  call void @"method.String.String_char_const"(i32 %".17", i32 134543928)
