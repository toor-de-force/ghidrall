; ModuleID = "pizza_ordering_system"
...
"5":
  ...
  %".94" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134559962, i32 %".93")
...
"6":
  ...
  %".113" = call i32 @"sym.cgc_strcmp"(i32 134560007, i32 %".112")
...
"7":
  ...
  %".127" = call i32 @"sym.cgc_strcmp"(i32 134560017, i32 %".126")
...
"8":
  ...
  %".137" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134560022, i32 %".136")
  store i8 1, i8* %".35"
  br label %"d"
"9":
  %".140" = load i32, i32* %"in_stack_ffbf6f0c"
  %".141" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134559986, i32 %".140")
...
a:
  ...
  %".153" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134560051, i32 %".152")
  store i8 1, i8* %".35"
  br label %"d"
b:
  store i8 1, i8* %".36"
  %".157" = load i32, i32* %"in_stack_ffbf6f0c"
  %".158" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134560569, i32 %".157")
  call void @"sym.print_banner"()
  br label %"4"
c:
  %".161" = load i32, i32* %"in_stack_ffbf6f0c"
  %".162" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134559986, i32 %".161")
  br label %"4"
d:
  %".164" = load i8, i8* %".36"
  %".165" = and i8 %".164", 1
...
e:
  ...
  %".173" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134560074, i32 %".172")
  %".174" = load i32, i32* %"in_stack_ffbf6f0c"
  %".175" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134560090, i32 %".174")
  %".176" = load i32, i32* %"in_stack_ffbf6f0c"
  %".177" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134560107, i32 %".176")
  %".178" = load i32, i32* %"in_stack_ffbf6f0c"
  %".179" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134560127, i32 %".178")
  %".180" = load i32, i32* %"in_stack_ffbf6f0c"
  %".181" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134560147, i32 %".180")
  %".182" = load i32, i32* %"in_stack_ffbf6f0c"
  %".183" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134560164, i32 %".182")
  %".184" = load i32, i32* %"in_stack_ffbf6f0c"
  %".185" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134560185, i32 %".184")
  %".186" = load i32, i32* %"in_stack_ffbf6f0c"
  %".187" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134560196, i32 %".186")
...
"4":
  ...
  %".43" = load i8, i8* %".42"
  %".44" = load i32, i32* %"var_18h"
  %".45" = zext i8 %".43" to i32
  %".46" = add i32 %".45", %".44"
  store i32 %".46", i32* %"register0x0000001c"
  %".48" = load i32, i32* %"register0x0000001c"
...
"5":
  ...
  br i1 %".64", label %"6", label %"7"
"6":
  %".66" = load i32, i32* %"var_18h"
  %".67" = load i32, i32* %"var_28h"
...
"0":
  ...
  %".7" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134559908, i32 %".6")
  ret void
}
...
"3":
  ...
  br label %"4"
"4":
  %".37" = getelementptr inbounds [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 999976
  %".38" = load i32, i32* %".14"
  %".39" = add i32 %".38", 4
  ...
  %".45" = load i8, i8* %".44"
  %".46" = load i32, i32* %"var_18h"
  %".47" = zext i8 %".45" to i32
  %".48" = add i32 %".47", %".46"
  store i32 %".48", i32* %"register0x0000001c"
  %".50" = load i32, i32* %"register0x0000001c"
  call void @"sym.imp.cgc_receive"()
  ...
  br i1 %".58", label %"5", label %"7"
"5":
  %".60" = load i32, i32* %"var_14h"
  %".61" = icmp eq i32 %".60", 1
