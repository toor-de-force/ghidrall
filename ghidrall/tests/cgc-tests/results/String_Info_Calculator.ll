; ModuleID = "String_Info_Calculator"
...
"0":
  ...
  br label %"1"
"1":
  %".41" = call i32 @"sym.cgc_send_bytes"(i32 1, i32 134535372, i32 24)
...
"6":
  ...
  br label %"7"
"7":
  %".82" = call i32 @"sym.cgc_send_bytes"(i32 1, i32 134535397, i32 25)
...
declare i32 @"sym.cgc_compute_hash"(i32 %"arg_8h", i32 %"arg_ch", i32 %"arg_10h") 
