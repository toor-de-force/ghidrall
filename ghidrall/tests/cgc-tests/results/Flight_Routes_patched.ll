; ModuleID = "Flight_Routes_patched"
...
"0":
  ...
  %".263" = call i32 @"sym.cgc_printf"(i32 134537960, i32 %".262")
...
"3":
  ...
  %".293" = call i32 @"sym.cgc_printf"(i32 134538087, i32 %".292")
  call void @"sym.imp.cgc__terminate"()
  br label %"5"
"4":
...
"5":
  ...
  %".304" = call i32 @"sym.cgc_printf"(i32 134537983, i32 %".303")
  br label %"15"
"6":
...
"7":
  ...
  %".314" = call i32 @"sym.cgc_printf"(i32 134538075, i32 %".313")
  br label %"15"
"8":
...
"9":
  ...
  %".324" = call i32 @"sym.cgc_printf"(i32 134538055, i32 %".323")
  br label %"15"
a:
...
b:
  ...
  %".334" = call i32 @"sym.cgc_printf"(i32 134538045, i32 %".333")
  br label %"15"
c:
...
d:
  ...
  %".344" = call i32 @"sym.cgc_printf"(i32 134538028, i32 %".343")
  br label %"15"
e:
...
f:
  ...
  %".354" = call i32 @"sym.cgc_printf"(i32 134538007, i32 %".353")
  br label %"15"
"10":
...
"11":
  ...
  %".364" = call i32 @"sym.cgc_printf"(i32 134537987, i32 %".363")
  br label %"15"
"12":
...
"13":
  ...
  %".374" = call i32 @"sym.cgc_printf"(i32 134538100, i32 %".373")
  br label %"15"
"14":
  %".376" = load i32, i32* %"arg_8h"
  %".377" = call i32 @"sym.cgc_printf"(i32 134537983, i32 %".376")
  br label %"15"
"15":
