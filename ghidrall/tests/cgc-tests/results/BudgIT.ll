...
"4":
  %".81" = call i32 @"func_0x0804a090"(i32 1, i32 134524611, i32 16)
...
"5":
  ...
  br label %"8"
"6":
  %".93" = call i32 @"func_0x0804a090"(i32 1, i32 134524590, i32 20)
...
b:
  ...
  br label %"c"
c:
  %".156" = call i32 @"func_0x0804a090"(i32 1, i32 134524628, i32 17)
...
"14":
  ...
  %".228" = call i32 @"sym.cgc_strcmp"(i32 %".227", i32 134524646)
