; ModuleID = "Diophantine_Password_Wallet_patched"
...
"0":
  ...
  br label %"1"
"1":
  %".43" = call i32 @"sym.cgc_my_printf"(i32 134522882)
  %".44" = call i32 @"sym.cgc_my_printf"(i32 134522926)
  ...
  %".52" = call i32 @"sym.cgc_my_printf"(i32 134522810)
  ...
  %".60" = call i32 @"sym.cgc_my_printf"(i32 134522824)
  ...
  %".68" = call i32 @"sym.cgc_my_printf"(i32 134522839)
...
"2":
  %".83" = call i32 @"sym.cgc_my_printf"(i32 134522933)
...
"4":
  %".126" = call i32 @"sym.cgc_my_printf"(i32 134522949)
  store i32 0, i32* %"register0x00000000"
