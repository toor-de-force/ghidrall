; ModuleID = "ASCII_Content_Server_patched"
...
"1":
  ...
  call void @"sym.cgc_PrintErrorAndTerminate"(i32 134541537, i32 %".33", i32 %".34", i32 %".35", i32 %".36", i32 %".37", i32 %".38", i32 %".32")
  br label %"2"
"2":
...
"4":
  ...
  call void @"sym.cgc_PrintErrorAndTerminate"(i32 134541562, i32 %".63", i32 %".64", i32 %".65", i32 %".66", i32 76, i32 0, i32 %".62")
  br label %"5"
"5":
