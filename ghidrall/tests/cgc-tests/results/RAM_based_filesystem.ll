...
"0":
  ...
  store i32 134544502, i32* %"arg_ch"
  %".33" = ptrtoint i64* @"obj.cgc_CWD" to i32
  %".34" = call i32 @"sym.cgc_strcpy"(i32 %".33", i32 134544502)
...
"1":
  call void @"sym.cgc_puts"(i32 134545009)
  call void @"sym.cgc_puts"(i32 134545037)
  %".46" = load i32, i32* %"arg_ch"
  %".47" = call i32 @"sym.cgc_printf"(i32 134545081, i32 %".46")
...
"4":
  ...
  br label %"14"
"5":
  call void @"sym.cgc_puts"(i32 134545100)
...
e:
  call void @"sym.cgc_puts"(i32 134545084)
  br label %"f"
f:
...
"11":
  ...
  %".148" = call i32 @"sym.cgc_printf"(i32 134545081, i32 %".147")
  br label %"2"
"12":
  ...
  %".156" = call i32 @"sym.cgc_printf"(i32 134545081, i32 %".155")
  br label %"2"
"13":
  call void @"sym.cgc_puts"(i32 134544967)
  store i32 -1, i32* %"var_8h"
  br label %"14"
"14":
