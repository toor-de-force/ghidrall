; ModuleID = "Movie_Rental_Service_Redux_patched"
...
"0":
  ...
  %".32" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134542311, i32 %".31")
  %".33" = load i32, i32* %"in_stack_ffffffac"
  %".34" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134542358, i32 %".33")
  %".35" = load i32, i32* %"in_stack_ffffffac"
  %".36" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134542401, i32 %".35")
  %".37" = load i32, i32* %"in_stack_ffffffac"
  %".38" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134542438, i32 %".37")
  br label %"1"
"1":
...
a:
  ...
  %".98" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134539406, i32 %".97")
  br label %"1"
b:
  %".100" = load i32, i32* %"in_stack_ffffffac"
  %".101" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134542485, i32 %".100")
