...
entry:
  ...
  br label %"0"
"0":
  store i32 134535408, i32* %"var_18h"
  br label %"1"
"1":
  %".59" = load i32, i32* %"in_stack_fffffefc"
  %".60" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134535423, i32 %".59")
  %".61" = load i32, i32* %"in_stack_fffffefc"
  %".62" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134535446, i32 %".61")
  %".63" = load i32, i32* %"in_stack_fffffefc"
  %".64" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134535469, i32 %".63")
  %".65" = load i32, i32* %"in_stack_fffffefc"
  %".66" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134535488, i32 %".65")
  %".67" = load i32, i32* %"in_stack_fffffefc"
  %".68" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134535504, i32 %".67")
  %".69" = load i32, i32* %"in_stack_fffffefc"
  %".70" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134535520, i32 %".69")
  %".71" = load i32, i32* %"in_stack_fffffefc"
  %".72" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134535579, i32 %".71")
  %".73" = load i32, i32* %"in_stack_fffffefc"
  %".74" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134535629, i32 %".73")
  %".75" = load i32, i32* %"in_stack_fffffefc"
  %".76" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134535647, i32 %".75")
  %".77" = load i32, i32* %"var_18h"
  store i32 %".77", i32* %"iVar1"
  %".79" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134535657, i32 134535408)
  %".80" = load i32, i32* %"iVar1"
  %".81" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134535683, i32 %".80")
  %".82" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134535718, i32 134535709)
  store i32 134535709, i32* %"in_stack_fffffefc"
  %".84" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134535740, i32 134535709)
  %".85" = load i32, i32* %"in_stack_fffffefc"
  %".86" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134535777, i32 %".85")
...
"2":
  ...
  %".106" = mul i32 %".105", 4
  %".107" = add i32 %".106", 134535384
  %".108" = call i32 @"unique0x00000f30"()
  %".109" = load i32, i32* %"uVar2"
  ret i32 %".109"
"3":
  %".111" = load i32, i32* %"in_stack_fffffefc"
  %".112" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134535829, i32 %".111")
  %".113" = load i32, i32* %"in_stack_fffffefc"
  %".114" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134534999, i32 %".113")
  br label %"1"
}
