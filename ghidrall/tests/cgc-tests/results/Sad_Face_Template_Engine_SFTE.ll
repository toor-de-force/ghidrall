; ModuleID = "Sad_Face_Template_Engine_SFTE"
...
"0":
  ...
  %".31" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134537273, i32 %".30")
  br label %"1"
"1":
  call void @"sym.cgc_print_menu"()
  %".34" = load i32, i32* %"iVar1"
  %".35" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134537276, i32 %".34")
...
"3":
  ...
  %".69" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134537288, i32 %".68")
  %".70" = load i32, i32* %"iVar1"
  %".71" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134537286, i32 %".70")
  br label %"1"
"4":
  %".73" = load i32, i32* %"register0x00000000"
  %".74" = mul i32 %".73", 4
  %".75" = add i32 %".74", 134536720
