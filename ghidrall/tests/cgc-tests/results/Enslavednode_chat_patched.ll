; ModuleID = "Enslavednode_chat_patched"
...
"2":
  %".18" = call i32 @"sym.cgc__error"(i32 1, i32 134534146, i32 388)
  br label %"3"
"3":
  %".20" = inttoptr i32 134534209 to i32**
...
"6":
  ...
  %".53" = call i32 @"sym.cgc_tick_common"(i32 %".50", i32** %".52", i32 134534198, i32 33)
...
b:
  ...
  %".87" = call i32 @"sym.cgc_tick_common"(i32 %".75", i32** %".86", i32 134534203, i32 10)
