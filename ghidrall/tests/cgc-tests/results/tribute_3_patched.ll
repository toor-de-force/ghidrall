...
"1":
  call void @"func_0x08048c00"()
  br label %"2"
"2":
  ret void
}

declare i32 @"sym.cgc_execute"() 

declare i32 @"sym.cgc_memset"(i32 %"arg_8h", i32 %"arg_ch", i32 %"arg_10h") 

declare i32 @"sym.cgc_run_program"(i32 %"arg_8h", i32 %"arg_ch") 
