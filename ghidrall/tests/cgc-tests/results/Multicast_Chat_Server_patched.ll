; ModuleID = "Multicast_Chat_Server_patched"
...
"6":
  ...
  %".58" = call i32 @"sym.cgc_strcmp"(i32 %".57", i32 134554526)
...
"7":
  ...
  %".68" = call i32 @"sym.cgc_strcmp"(i32 %".67", i32 134554532)
...
a:
  ...
  %".108" = call i32 @"sym.cgc_strcmp"(i32 %".107", i32 134554510)
...
b:
  ...
  %".118" = call i32 @"sym.cgc_strcmp"(i32 %".117", i32 134554521)
...
c:
  ...
  %".128" = call i32 @"sym.cgc_strcmp"(i32 %".127", i32 134554539)
