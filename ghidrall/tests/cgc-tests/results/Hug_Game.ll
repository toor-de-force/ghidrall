...
"1":
  %".53" = call i32 @"sym.cgc_put"(i32 136709137)
  call void @"sym.imp.cgc__terminate"()
  br label %"2"
"2":
  %".56" = load i32, i32* @"obj.state"
  %".57" = add i32 %".56", 260
  %".58" = call i32 @"sym.cgc_put"(i32 136709190)
  %".59" = call i32 @"sym.cgc_put"(i32 136709227)
  ...
  %".70" = call i32 @"sym.cgc_put"(i32 136709247)
  ...
  %".76" = call i32 @"sym.cgc_put"(i32 136709251)
...
"5":
  ...
  br label %"6"
"6":
  %".99" = call i32 @"sym.cgc_put"(i32 136709254)
  ...
  %".106" = call i32 @"sym.cgc_put"(i32 136709264)
...
f:
  %".160" = call i32 @"sym.cgc_put"(i32 136709346)
  call void @"sym.imp.cgc__terminate"()
  br label %"3"
"10":
  %".163" = call i32 @"sym.cgc_put"(i32 136709407)
