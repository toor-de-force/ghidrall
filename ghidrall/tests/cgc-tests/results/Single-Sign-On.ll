...
"1":
  ...
  %".49" = call i32 @"sym.cgc_strcmp"(i32 134525745, i32 %".48")
...
"3":
  ...
  %".67" = call i32 @"sym.cgc_strcmp"(i32 134525767, i32 %".66")
...
"4":
  ...
  call void @"sym.cgc_reportMessage"(i32 134525772, i32 25)
...
"6":
  ...
  %".93" = call i32 @"sym.cgc_strcmp"(i32 134525798, i32 %".92")
...
"7":
  ...
  %".104" = call i32 @"sym.cgc_strcmp"(i32 134525844, i32 %".103")
...
"10":
  call void @"sym.cgc_reportMessage"(i32 134525828, i32 15)
  br label %"1"
"11":
  call void @"sym.cgc_reportMessage"(i32 134525803, i32 24)
  br label %"1"
"12":
  call void @"sym.cgc_reportMessage"(i32 134525750, i32 16)
  br label %"1"
"13":
