...
"0":
  ...
  %".37" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134539740, i32 %".36")
...
"1":
  ...
  %".51" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134539245, i32 %".50")
...
"7":
  ...
  %".87" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134539245, i32 %".86")
  br label %"3"
"8":
...
f:
  ...
  %".121" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134539765, i32 %".120")
  br label %"3"
}
