...
"1":
  ...
  call void @"sym.cgc_recvMsg"(i32 4, i32 %".31", i32 8)
...
"3":
  ...
  call void @"sym.cgc_recvMsg"(i32 4, i32 %".47", i32 %".48")
...
"7":
  ...
  %".109" = call i32 @"sym.cgc_snprintf"(i32 %".106", i32 %".108", i32 134612206, i32 %".107")
  ...
  call void @"sym.cgc_sendMsg"(i32 4, i32 %".116", i32 8)
  %".118" = ptrtoint i64* @"obj.gOutBuf" to i32
  %".119" = load i32, i32* %"var_14h"
  call void @"sym.cgc_sendMsg"(i32 4, i32 %".118", i32 %".119")
  br label %"1"
"8":
