...
"5":
  store i32 134531711, i32* %"placeholder_1"
  %".74" = load i32, i32* %"iVar3"
  %".75" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134531711, i32 %".74")
...
"6":
  ...
  %".86" = call i32 @"func_0x0804c560"(i32 0)
...
declare i32 @"func_0x0804c560"(i32 %".1") 
