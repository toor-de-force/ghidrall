...
"4":
  call void @"sym.cgc_sendErrorResponse"(i32 134535262)
...
"5":
  ...
  %".55" = call i32 @"sym.cgc_strlen"(i32 134535278)
  store i32 %".55", i32* %"arg_10h"
  %".57" = load i32, i32* %"iVar1"
  %".58" = load i32, i32* %"arg_10h"
  %".59" = call i32 @"sym.cgc_strncmp"(i32 %".57", i32 134535278, i32 %".58")
...
"6":
  %".68" = call i32 @"sym.cgc_strlen"(i32 134535157)
