...
"1":
  ...
  %".28" = call i32 @"sym.cgc_printf"(i32 134554124, i32 %".27")
...
"11":
  ...
  %".135" = call i32 @"sym.cgc_printf"(i32 134554265, i32 %".134")
...
"4":
  ...
  %".47" = call i32 @"sym.cgc_strchr"(i32 134554377, i32 %".46")
  store i32 %".47", i32* %"iVar1"
  %".49" = load i32, i32* %"iVar1"
  %".50" = icmp eq i32 %".49", 0
  %".51" = bitcast i8* %"register0x00000206" to i1*
