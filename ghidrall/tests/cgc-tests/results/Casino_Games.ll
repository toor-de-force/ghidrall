...
entry:
  ...
  %"in_stack_fffffec8" = bitcast i8* %".4" to i32*
  %".5" = getelementptr [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 999708
  %"var_120h" = bitcast i8* %".5" to i32*
  %".6" = getelementptr [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 999712
  %"var_11ch" = bitcast i8* %".6" to i32*
  ...
  %".20" = getelementptr [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 999843
  %"var_99h" = bitcast i8* %".20" to i32*
  ...
  %".30" = getelementptr [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 999887
  ...
  %".33" = getelementptr [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 999896
  %"var_64h" = bitcast i8* %".33" to i32*
  ...
  %".36" = getelementptr [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 999912
  %"var_54h" = bitcast i8* %".36" to i32*
  %".37" = getelementptr [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 999916
  %"var_50h" = bitcast i8* %".37" to i32*
  %".38" = getelementptr [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 999920
  %"var_4ch" = bitcast i8* %".38" to i32*
  ...
  br label %"0"
"0":
  %".45" = load i32, i32* %"in_stack_fffffec8"
  %".46" = call i32 @"sym.cgc_printf"(i32 134536336, i32 %".45")
  %".47" = getelementptr inbounds [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 999912
  %".48" = getelementptr inbounds [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 999920
  call void @"sym.imp.cgc_receive"()
  %".50" = load i32, i32* %"var_50h"
  %".51" = icmp ne i32 %".50", 0
...
"2":
  ...
  br label %"3"
"3":
  %".66" = getelementptr inbounds [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 999920
  %".67" = getelementptr inbounds [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 999920
  %".68" = ptrtoint i8* %".67" to i32
  %".69" = load i32, i32* %"var_54h"
  %".70" = add i32 %".68", %".69"
...
"4":
  %".86" = getelementptr inbounds [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 999920
  %".87" = ptrtoint i8* %".86" to i32
  %".88" = call i32 @"sym.cgc_strlen"(i32 %".87")
  store i32 %".88", i32* %"iVar1"
  %".90" = load i32, i32* %"iVar1"
  %".91" = add i32 %".90", 3
  %".92" = getelementptr inbounds [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 999916
  %".93" = ptrtoint i8* %".92" to i32
  %".94" = add i32 %".93", %".91"
  %".95" = trunc i32 %".94" to i8
  br label %"5"
"5":
  %".97" = getelementptr inbounds [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 999920
  %".98" = ptrtoint i8* %".97" to i32
  %".99" = call i32 @"sym.cgc_printf"(i32 134536143, i32 %".98")
  store i32 0, i32* %"var_5ch"
  store i32 0, i32* %"var_60h"
  store i32 0, i32* %"var_64h"
  br label %"6"
"6":
  %".104" = getelementptr inbounds [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 999920
  %".105" = ptrtoint i8* %".104" to i32
  %".106" = call i32 @"sym.cgc_strlen"(i32 %".105")
  store i32 %".106", i32* %"uVar2"
  %".108" = load i32, i32* %"var_64h"
...
"7":
  %".116" = load i32, i32* %"var_5ch"
  %".117" = shl i32 %".116", 8
  %".118" = load i32, i32* %"var_60h"
  %".119" = lshr i32 %".118", 24
  store i32 %".119", i32* %"uVar2"
  %".121" = load i32, i32* %"uVar2"
  %".122" = or i32 %".117", %".121"
  store i32 %".122", i32* %"register0x00000008"
  %".124" = load i32, i32* %"var_60h"
  %".125" = shl i32 %".124", 8
  store i32 %".125", i32* %"register0x00000000"
  %".127" = load i32, i32* %"var_5ch"
  %".128" = lshr i32 %".127", 24
  store i32 %".128", i32* %"register0x00000004"
  %".130" = getelementptr inbounds [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 999920
  %".131" = ptrtoint i8* %".130" to i32
  %".132" = load i32, i32* %"var_64h"
  %".133" = add i32 %".131", %".132"
  ...
  %".146" = or i32 %".144", %".145"
  store i32 %".146", i32* %"var_60h"
  %".148" = load i32, i32* %"register0x00000008"
  %".149" = load i32, i32* %"register0x0000001c"
  %".150" = or i32 %".148", %".149"
  store i32 %".150", i32* %"var_5ch"
  %".152" = load i32, i32* %"var_64h"
  %".153" = add i32 %".152", 1
  store i32 %".153", i32* %"var_64h"
  br label %"6"
"8":
  %".156" = load i32, i32* %"var_5ch"
  store i32 %".156", i32* %"iVar1"
  %".158" = load i32, i32* %"var_60h"
  %".159" = load i32, i32* %"var_5ch"
  call void @"sym.cgc_sprng"(i32 %".158", i32 %".159")
  %".161" = load i32, i32* %"var_5ch"
  %".162" = xor i32 %".161", 1684156720
  store i32 %".162", i32* %"register0x00000004"
  %".164" = load i32, i32* %"var_60h"
...
"9":
  ...
  %".179" = call i32 @"sym.cgc_printf"(i32 134536390, i32 %".178")
...
b:
  ...
  %".185" = call i32 @"sym.cgc_printf"(i32 134535308, i32 %".184")
  %".186" = load i32, i32* %"iVar1"
  %".187" = call i32 @"sym.cgc_printf"(i32 134536406, i32 %".186")
  %".188" = load i32, i32* %"iVar1"
  %".189" = call i32 @"sym.cgc_printf"(i32 134536425, i32 %".188")
  %".190" = load i32, i32* %"iVar1"
  %".191" = call i32 @"sym.cgc_printf"(i32 134536440, i32 %".190")
  %".192" = load i32, i32* %"iVar1"
  %".193" = call i32 @"sym.cgc_printf"(i32 134536455, i32 %".192")
  %".194" = load i32, i32* %"iVar1"
  %".195" = call i32 @"sym.cgc_printf"(i32 134536487, i32 %".194")
  %".196" = load i32, i32* %"iVar1"
  %".197" = call i32 @"sym.cgc_printf"(i32 134536513, i32 %".196")
  %".198" = load i32, i32* %"iVar1"
  %".199" = call i32 @"sym.cgc_printf"(i32 134536536, i32 %".198")
  %".200" = load i32, i32* %"iVar1"
  %".201" = call i32 @"sym.cgc_printf"(i32 134536557, i32 %".200")
  %".202" = load i32, i32* %"iVar1"
  %".203" = call i32 @"sym.cgc_printf"(i32 134536566, i32 %".202")
  %".204" = getelementptr inbounds [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 999887
