; ModuleID = "Bloomy_Sunday_patched"
...
"0":
  ...
  %".46" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134531198, i32 %".45")
  call void @"sym.cgc_init"()
  br label %"1"
"1":
  call void @"sym.cgc_print_menu"()
  %".50" = load i32, i32* %"in_stack_fffff76c"
  %".51" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134531231, i32 %".50")
...
"2":
  ...
  %".66" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134531285, i32 %".65")
...
"4":
  store i32 134531248, i32* %"placeholder_1"
  %".83" = load i32, i32* %"in_stack_fffff76c"
  %".84" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134531248, i32 %".83")
...
"9":
  ...
  %".120" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134531245, i32 %".119")
  br label %"c"
a:
  %".122" = load i32, i32* %"in_stack_fffff76c"
  %".123" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134531234, i32 %".122")
  br label %"c"
b:
  %".125" = load i32, i32* %"in_stack_fffff76c"
  %".126" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134531278, i32 %".125")
  br label %"c"
c:
  %".128" = load i32, i32* %"in_stack_fffff76c"
  %".129" = call i32 @"sym.cgc_fdprintf"(i32 1, i32 134531276, i32 %".128")
  br label %"1"
}
