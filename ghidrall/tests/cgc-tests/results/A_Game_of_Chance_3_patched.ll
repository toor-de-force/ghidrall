; ModuleID = "A_Game_of_Chance_3_patched"
...
"0":
  ...
  %".24" = call i32 @"sym.recv_bytes"(i32 8, i32 %".23", i32 6)
...
"0":
  ...
  %".27" = call i32 @"sym.recv_bytes"(i32 8, i32 %".25", i32 %".26")
...
"0":
  ...
  %".26" = call i32 @"sym.recv_bytes"(i32 8, i32 %".24", i32 %".25")
...
"0":
  ...
  %".19" = load i32, i32* %"register0x00000008"
  %".20" = call i32 @"sym.recv_bytes"(i32 8, i32 %".18", i32 %".19")
...
"0":
  ...
  %".13" = call i32 @"sym.recv_bytes"(i32 8, i32 %".12", i32 1)
...
"2":
  ...
  %".22" = call i32 @"sym.recv_bytes"(i32 8, i32 %".21", i32 1)
