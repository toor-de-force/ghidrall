...
"1":
  ...
  store i8* %".36", i8** %".37"
  store i32 1024, i32* %"placeholder_2"
  store i32 10, i32* %"placeholder_3"
  %".41" = load i32, i32* %"arg_ch"
  %".42" = load i32, i32* @"obj.read_fd"
  %".43" = call i32 @"sym.cgc_read_until"(i32 %".42", i32 %".41", i32 1024, i32 10)
...
"2":
  ...
  call void @"sym.cgc_exit"(i32 4, i32 %".53", i32 %".54", i32 %".55", i32 %".56", i32 %".57", i32 %".58", i32 %".59", i32 %".60", i32 4, i32 10, i32 1024)
  br label %"3"
"3":
...
"5":
  ...
  call void @"sym.cgc_exit"(i32 0, i32 %".75", i32 %".76", i32 %".77", i32 %".78", i32 %".79", i32 %".80", i32 %".81", i32 0, i32 %".82", i32 10, i32 1024)
  br label %"6"
"6":
  ...
  %".94" = call i32 @"sym.cgc_search"(i32 %".92", i32 %".93")
...
"7":
  ...
  %".106" = call i32 @"sym.cgc_printf"(i32 %".105", i32 134526609, i32 %".104")
...
declare i32 @"sym.cgc_search"(i32 %"arg_8h", i32 %"arg_ch") 
