; ModuleID = "REMATCH_1--Hat_Trick--Morris_Worm_4_patched"
...
"4":
  ...
  %".69" = call i32 @"sym.cgc_equals"(i32 %".68", i32 134538813)
...
"7":
  ...
  store i32 134539387, i32* %"var_2ech"
...
"14":
  ...
  %".200" = call i32 @"sym.cgc_send_all_fd"(i32 5, i32 134539396, i32 2)
  br label %"1"
}
