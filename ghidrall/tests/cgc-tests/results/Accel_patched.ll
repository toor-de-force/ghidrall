...
"1":
  ...
  %".28" = call i32 @"sym.cgc_printf"(i32 134549080, i32 %".27")
...
"3":
  ...
  %".63" = mul i32 %".62", 4
  %".64" = add i32 %".63", 134549040
  %".65" = call i32 @"unique0x00000f30"()
  %".66" = load i32, i32* %"uVar2"
  ret i32 %".66"
"4":
  %".68" = load i32, i32* %"in_stack_fffffd98"
  %".69" = call i32 @"sym.cgc_printf"(i32 134549230, i32 %".68")
  br label %"1"
"5":
  %".71" = load i32, i32* %"in_stack_fffffd98"
  %".72" = call i32 @"sym.cgc_printf"(i32 134549275, i32 %".71")
  br label %"1"
}
