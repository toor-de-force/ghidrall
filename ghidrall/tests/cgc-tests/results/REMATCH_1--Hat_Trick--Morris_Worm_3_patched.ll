; ModuleID = "REMATCH_1--Hat_Trick--Morris_Worm_3_patched"
...
c:
  ...
  %".158" = call i32 @"sym.cgc_equals"(i32 %".157", i32 134536045)
...
f:
  ...
  %".176" = call i32 @"sym.cgc_send_all_fd"(i32 5, i32 134536510, i32 2)
  br label %"9"
}
