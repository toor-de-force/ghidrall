; ModuleID = "REMATCH_1--Hat_Trick--Morris_Worm_2_patched"
...
"6":
  ...
  %".103" = call i32 @"sym.cgc_equals"(i32 %".102", i32 134536365)
...
"9":
  ...
  %".119" = call i32 @"sym.cgc_send_all_fd"(i32 5, i32 134536819, i32 2)
  br label %"3"
}
