; ModuleID = "Movie_Rental_Service_patched"
...
"0":
  ...
  call void @"sym.imp.memcpy"()
  store i32 134537057, i32* %"arg_ch"
  call void @"sym.imp.memcpy"()
  ...
  %".71" = call i32 @"sym.cgc_printf"(i32 134537132, i32 %".70")
  br label %"1"
"1":
...
"4":
  ...
  %".113" = mul i32 %".112", 4
  %".114" = add i32 %".113", 134533424
  call void @"unique0x00000f30"()
  ret void
"5":
  %".117" = load i32, i32* %"arg_ch"
  %".118" = call i32 @"sym.cgc_printf"(i32 134537178, i32 %".117")
  br label %"1"
}
