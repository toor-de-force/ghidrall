...
entry:
  ...
  br label %"0"
"0":
  %".39" = call i32 @"sym.cgc_make_tree"(i32 0, i32 0, i32 134537796, i32 134537796)
...
d:
  store i32 134537908, i32* %"pcVar3"
  store i32 134537797, i32* %"pcVar4"
  store i32 656, i32* %"iVar2"
  %".150" = call i32 @"sym.cgc_fdprintf"(i32 2, i32 134537908, i32 134537797)
  ...
  br label %"e"
e:
  %".156" = call i32 @"sym.cgc_transmit_string"(i32 5, i32 134537795)
...
f:
  ...
  %".168" = call i32 @"sym.cgc_fdprintf"(i32 2, i32 134537908, i32 134537797)
...
"18":
  ...
  br label %"1"
"19":
  %".251" = call i32 @"sym.cgc_transmit_string"(i32 5, i32 134537898)
...
"1a":
  ...
  %".263" = call i32 @"sym.cgc_fdprintf"(i32 2, i32 134537908, i32 134537797)
