...
"0":
  ...
  %".46" = call i32 @"sym.cgc_printf"(i32 134550734, i32 %".45")
...
"1":
  ...
  %".56" = call i32 @"sym.cgc_printf"(i32 134550764, i32 %".55")
...
"3":
  ...
  %".75" = call i32 @"sym.cgc_printf"(i32 134550793, i32 %".74")
  call void @"sym.imp.cgc__terminate"()
  br label %"4"
"4":
...
"5":
  ...
  %".97" = call i32 @"sym.cgc_printf"(i32 134550843, i32 %".96")
  call void @"sym.imp.cgc__terminate"()
  br label %"6"
"6":
...
"7":
  ...
  %".108" = call i32 @"sym.cgc_printf"(i32 134550843, i32 %".107")
  call void @"sym.imp.cgc__terminate"()
  br label %"8"
"8":
  ...
  %".129" = call i32 @"sym.cgc_printf"(i32 134550913, i32 %".128")
  %".130" = mul i32 2, 16
  %".131" = getelementptr inbounds i32, i32* %"arg_8h", i32 %".130"
  %".132" = ptrtoint i32* %".131" to i32
  %".133" = call i32 @"sym.cgc_printf"(i32 134550927, i32 %".132")
  %".134" = mul i32 2, 16
...
"9":
  ...
  %".152" = call i32 @"sym.cgc_printf"(i32 134550941, i32 %".151")
  store i32 0, i32* %"var_8h"
  br label %"b"
a:
  %".155" = load i32, i32* %"arg_ch"
  %".156" = call i32 @"sym.cgc_printf"(i32 134550289, i32 %".155")
...
declare i8 @"sym.cgc_getEntryInfo"(i32 %"arg_8h", i32 %"arg_ch", i32 %"arg_10h", i32 %"arg_14h") 
