...
entry:
  ...
  %"iVar1" = alloca i32
  %".4" = getelementptr [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 826040
  %"var_2a784h" = bitcast i8* %".4" to i32*
  %".5" = getelementptr [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 826052
  %"var_2a778h" = bitcast i8* %".5" to i32*
  %".6" = getelementptr [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 826056
  %"var_2a774h" = bitcast i8* %".6" to i32*
  %".7" = getelementptr [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 826060
  %"var_2a770h" = bitcast i8* %".7" to i32*
  %".8" = getelementptr [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 826064
  %"var_2a76ch" = bitcast i8* %".8" to i32*
  %".9" = getelementptr [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 826068
  %"var_2a768h" = bitcast i8* %".9" to i32*
  %".10" = getelementptr [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 996472
  %"var_dc4h" = bitcast i8* %".10" to i32*
  %".11" = getelementptr [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 996476
  %"var_dc0h" = bitcast i8* %".11" to i32*
  %".12" = getelementptr [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 996480
  %"var_dbch" = bitcast i8* %".12" to i32*
  %".13" = getelementptr [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 996484
  %"var_db8h" = bitcast i8* %".13" to i32*
...
"2":
  %".30" = getelementptr inbounds [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 996484
...
"4":
  call void @"sym.cgc_print"(i32 134525048)
  call void @"sym.imp.cgc__terminate"()
  br label %"3"
"5":
  %".61" = load i32, i32* %"register0x00000000"
  %".62" = mul i32 %".61", 4
  %".63" = add i32 %".62", 134524976
  call void @"unique0x00000f30"()
  ret void
"6":
  %".66" = getelementptr inbounds [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 826068
