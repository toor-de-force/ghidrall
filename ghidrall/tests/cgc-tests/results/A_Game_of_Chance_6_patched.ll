; ModuleID = "A_Game_of_Chance_6_patched"
...
"0":
  ...
  %".24" = call i32 @"sym.recv_bytes"(i32 14, i32 %".23", i32 6)
...
"0":
  ...
  %".15" = bitcast i32* %"arg_ch" to i8**
  store i8* %".14", i8** %".15"
  %".17" = load i8, i8* @"obj.players"
  %".18" = zext i8 %".17" to i32
  store i32 %".18", i32* %"register0x00000008"
  %".20" = load i32, i32* %"register0x00000008"
  %".21" = add i32 %".20", 1
  store i32 %".21", i32* %"register0x00000008"
  %".23" = load i32, i32* %"register0x00000008"
  %".24" = mul i32 %".23", 4
  store i32 %".24", i32* %"arg_10h"
  %".26" = load i32, i32* %"arg_ch"
  %".27" = load i32, i32* %"arg_10h"
  %".28" = call i32 @"sym.recv_bytes"(i32 14, i32 %".26", i32 %".27")
  store i32 %".28", i32* %"iVar1"
  %".30" = load i32, i32* %"iVar1"
  %".31" = icmp slt i32 %".30", 0
  br i1 %".31", label %"1", label %"2"
"1":
  %".33" = load i32, i32* %"arg_ch"
  %".34" = load i32, i32* %"arg_10h"
  call void @"sym.imp.cgc__terminate"()
  br label %"2"
"2":
  ...
  br label %"3"
"3":
  %".39" = load i8, i8* @"obj.players"
  %".40" = zext i8 %".39" to i32
  store i32 %".40", i32* %"register0x00000004"
  %".42" = load i32, i32* %"var_2ch"
  %".43" = load i32, i32* %"register0x00000004"
  %".44" = icmp ule i32 %".42", %".43"
  br i1 %".44", label %"5", label %"4"
"4":
  ret void
"5":
  %".47" = getelementptr inbounds [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 999956
  %".48" = load i32, i32* %"var_2ch"
  %".49" = mul i32 %".48", 32
...
"6":
  %".59" = load i32, i32* @"obj.bogus"
  %".60" = add i32 %".59", 1
  store i32 %".60", i32* @"obj.bogus"
  br label %"7"
"7":
  %".63" = load i32, i32* %"var_2ch"
  %".64" = icmp eq i32 %".63", 5
  %".65" = bitcast i8* %"register0x00000206" to i1*
  store i1 %".64", i1* %".65"
  %".67" = load i8, i8* %"register0x00000206"
  %".68" = trunc i8 %".67" to i1
  br i1 %".68", label %"8", label %"a"
"8":
  %".70" = load i32, i32* @"obj.my_wager"
  %".71" = load i32, i32* %"iStack24"
...
"0":
  ...
  %".26" = call i32 @"sym.recv_bytes"(i32 14, i32 %".24", i32 %".25")
...
"2":
  %".14" = load i32, i32* %".5"
  store i32 %".14", i32* @"obj.fp_idx"
  br label %"5"
"3":
  %".17" = load i32, i32* %".5"
  %".18" = add i32 %".17", 4096
  store i32 %".18", i32* @"obj.fp_idx"
  br label %"5"
"4":
  %".21" = load i32, i32* %".5"
  %".22" = add i32 %".21", -4096
  store i32 %".22", i32* @"obj.fp_idx"
  br label %"5"
"5":
  ret void
}
...
"0":
  ...
  %".20" = call i32 @"sym.recv_bytes"(i32 14, i32 %".18", i32 %".19")
...
"0":
  ...
  %".13" = call i32 @"sym.recv_bytes"(i32 14, i32 %".12", i32 1)
...
"2":
  ...
  %".22" = call i32 @"sym.recv_bytes"(i32 14, i32 %".21", i32 1)
