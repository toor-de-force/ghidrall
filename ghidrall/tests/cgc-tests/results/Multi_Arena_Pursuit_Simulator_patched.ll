; ModuleID = "Multi_Arena_Pursuit_Simulator_patched"
...
entry:
  ...
  %".50" = getelementptr [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 999828
  %"var_a8h" = bitcast i8* %".50" to i32*
...
"0":
  ...
  store i32 1128775680, i32* %"var_c0h"
  store i32 0, i32* %"var_c4h"
  br label %"1"
"1":
  %".68" = load i32, i32* %"var_c4h"
...
"5":
  ...
  %".109" = getelementptr inbounds [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 999828
  %".110" = ptrtoint i8* %".109" to i32
  call void @"sym.cgc_bzero"(i32 %".110", i32 100)
  %".112" = getelementptr inbounds [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 999828
  %".113" = load i32, i32* %"var_ch"
  store i32 %".113", i32* %"iVar3"
  %".115" = ptrtoint i8* %".112" to i32
  %".116" = load i32, i32* %"var_10h"
  %".117" = call i32 @"sym.cgc_sprintf"(i32 %".115", i32 134551527, i32 %".116")
  %".118" = getelementptr inbounds [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 999828
...
"7":
  ...
  %".143" = load i32, i32* %"var_b4h"
  %".144" = add i32 %".143", 1
  store i32 %".144", i32* %"var_b4h"
...
"8":
  %".158" = getelementptr inbounds [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 999828
  %".159" = ptrtoint i8* %".158" to i32
  call void @"sym.cgc_bzero"(i32 %".159", i32 100)
  %".161" = getelementptr inbounds [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 999828
  %".162" = ptrtoint i8* %".161" to i32
  %".163" = load i32, i32* %"var_b4h"
  %".164" = call i32 @"sym.cgc_sprintf"(i32 %".162", i32 134551549, i32 %".163")
  %".165" = getelementptr inbounds [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 999828
...
"9":
  ...
  br label %"a"
a:
  %".182" = load i32, i32* %"var_c8h"
  %".183" = add i32 %".182", 1
  store i32 %".183", i32* %"var_c8h"
  br label %"4"
b:
...
c:
  %".202" = call i32 @"sym.cgc_strlen"(i32 134551578)
  store i32 %".202", i32* %"iVar3"
  %".204" = load i32, i32* %"iVar3"
  %".205" = call i32 @"sym.cgc_transmit_all"(i32 1, i32 134551578, i32 %".204")
...
e:
  ...
  %".219" = getelementptr inbounds [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 999828
  %".220" = ptrtoint i8* %".219" to i32
  call void @"sym.cgc_bzero"(i32 %".220", i32 100)
  %".222" = getelementptr inbounds [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 999828
  %".223" = load i32, i32* %"var_ch"
  store i32 %".223", i32* %"iVar3"
  %".225" = ptrtoint i8* %".222" to i32
  %".226" = load i32, i32* %"var_10h"
  %".227" = call i32 @"sym.cgc_sprintf"(i32 %".225", i32 134551527, i32 %".226")
  %".228" = getelementptr inbounds [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 999828
...
"10":
  ...
  store i32 0, i32* %"var_cch"
  br label %"11"
"11":
  store i32 0, i32* %"var_b4h"
  %".259" = load i32, i32* %"var_cch"
...
"12":
  ...
  %".265" = getelementptr inbounds [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 999828
  %".266" = ptrtoint i8* %".265" to i32
  call void @"sym.cgc_bzero"(i32 %".266", i32 100)
  %".268" = getelementptr inbounds [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 999828
  %".269" = load i32, i32* %"var_ch"
  store i32 %".269", i32* %"iVar3"
  %".271" = ptrtoint i8* %".268" to i32
  %".272" = load i32, i32* %"var_10h"
  %".273" = call i32 @"sym.cgc_sprintf"(i32 %".271", i32 134551527, i32 %".272")
  %".274" = getelementptr inbounds [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 999828
...
"14":
  ...
  %".299" = load i32, i32* %"var_b4h"
  %".300" = add i32 %".299", 1
  store i32 %".300", i32* %"var_b4h"
...
"15":
  %".314" = getelementptr inbounds [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 999828
  %".315" = ptrtoint i8* %".314" to i32
  call void @"sym.cgc_bzero"(i32 %".315", i32 100)
  %".317" = getelementptr inbounds [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 999828
  %".318" = ptrtoint i8* %".317" to i32
  %".319" = load i32, i32* %"var_b4h"
  %".320" = call i32 @"sym.cgc_sprintf"(i32 %".318", i32 134551549, i32 %".319")
  %".321" = getelementptr inbounds [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 999828
...
"16":
  ...
  br label %"17"
"17":
  %".338" = load i32, i32* %"var_cch"
  %".339" = add i32 %".338", 1
  store i32 %".339", i32* %"var_cch"
  br label %"11"
"18":
...
"19":
  %".358" = call i32 @"sym.cgc_strlen"(i32 134551578)
  store i32 %".358", i32* %"iVar3"
  %".360" = load i32, i32* %"iVar3"
  %".361" = call i32 @"sym.cgc_transmit_all"(i32 1, i32 134551578, i32 %".360")
...
"1b":
  ...
  %".375" = getelementptr inbounds [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 999828
  %".376" = ptrtoint i8* %".375" to i32
  call void @"sym.cgc_bzero"(i32 %".376", i32 100)
  %".378" = getelementptr inbounds [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 999828
  %".379" = load i32, i32* %"var_ch"
  store i32 %".379", i32* %"iVar3"
  %".381" = ptrtoint i8* %".378" to i32
  %".382" = load i32, i32* %"var_10h"
  %".383" = call i32 @"sym.cgc_sprintf"(i32 %".381", i32 134551527, i32 %".382")
  %".384" = getelementptr inbounds [999999 x i8], [999999 x i8]* %"stack", i32 0, i32 999828
