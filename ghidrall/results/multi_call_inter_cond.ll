; ModuleID = "multi_call_inter_cond"
target triple = "x86_64-pc-linux-gnu"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"

define void @"sym.func2_int"(i64 %".1") 
{
entry:
  %"var_4h" = alloca i64
  br label %"0x000009c3"
...
"0x000009dc":
  ...
  %".7" = icmp eq i32 %".6", 5
  br i1 %".7", label %"0x000009f9", label %"0x000009ed"
"0x000009f9":
  %".9" = load i32, i32* %"iVar1"
  %".10" = icmp slt i32 %".9", 6
  br i1 %".10", label %"0x00000a0b", label %"0x000009ff"
"0x00000a0b":
  %".12" = load i32, i32* %"iVar1"
  %".13" = add i32 %".12", 66
  %".14" = zext i32 %".13" to i64
  call void @"sym.func2_int"(i64 %".14")
  br label %"0x00000a19"
"0x000009ff":
  %".17" = and i64 %".1", 4294967295
  call void @"sym.func2_int"(i64 %".17")
  br label %"0x00000a19"
"0x000009ed":
  %".20" = and i64 %".1", 4294967295
  call void @"sym.func2_int"(i64 %".20")
  br label %"0x00000a19"
"0x00000a19":
  ret void
}
